...
while ( i < starWarsCharacters.length) {
  crewMass += starWarsCharacters[i].mass * 1; // crewMass somma ogni volta con starWARScharacters
  i++;
}

console.log("Massa totale è:", crewMass);
...
for (let i = 0; i <starWarsCharacters.gender,1; i++) {
  starWarsCharacters.gender = 'male'
}
